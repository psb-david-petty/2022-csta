...
/** Utilities has static methods for formatting unit-test data.
 * <p>
...
public final class Utilities {
    ...
    /** Utilities has only static methods */
     ...
     * <p>
     * TODO: Utilities.Mod.LOCAL should only be used to indicate a local variable
     */
    public enum Mod {
        PUBLIC("public "),
        PRIVATE("private "),
        PROTECTED("protected "),
        PACKAGE(""),
        LOCAL("INVALID");   // TODO: Utilities.Mod.LOCAL.mod is invalid
     ...
     *
     * @param message string to incorporate in the banner
     * @return banner with message centered.
     */
    public static String formatBanner(String message) {
        final String banner =
            "////////////////////////////////////////////////////////////////////////";
        if (banner.length() - message.length() < 2) return message;
        final int left = (banner.length() - message.length() - 2) / 2 + message.length() % 2;
        final int right = (banner.length() - message.length() - 2) / 2;
